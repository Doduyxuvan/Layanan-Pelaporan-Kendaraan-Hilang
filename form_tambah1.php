...
<div id="main">
    ...
    <div class="container">
        ...
        <h3>Input Data Pelapor</h3>
        <form action="proses_tambah11.php" method="post">        
            <table>
                <tr>
                    <td>Nomor SIM</td>
                    <td><input type="text" name="nosim" required></td>                    
                </tr>    
                <tr>
                    <td>Nama Pelapor</td>
                    <td><input type="text" name="nape" required></td>                    
                </tr>    
                <tr>
                    <td>Tanggal Lahir</td>
                    <td><input type="text" name="tala" required></td>                    
                </tr>    
                <tr>
                    <td>Tempat Lahir</td>
        ...
        <select name="gender" required>
            ...
            <option value="wanita" <?php echo (isset($data['gender']) && $data['gender'] == 'wanita') ? 'selected' : ''; ?>>Wanita</option>
                ...
                <tr>
                    ...
                    <td><input type="text" name="kewar" required></td>                    
                </tr>
