...
// Include file untuk memeriksa akses
...
<div id="main">
    ...
    <div class="container">
        <div>
        <a href="form_tambah.php" style="text-decoration: none;">
            ...
            <table class="table">
                ...
                while($data = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($data['bbm']); ?></td>
                        ...
                        <td>
                            <a href="form_edit.php?id=<?php echo $data['id']; ?>"><i class="fas fa-edit"></i></a>
                            <a href="proses_hapus.php?id=<?php echo $data['id']; ?>"><i class="fas fa-trash-alt"></i></a>
                        </td>
                    </tr>
                <?php
                } ?>
